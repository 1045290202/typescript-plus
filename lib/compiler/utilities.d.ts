...
/** @internal */
export declare function tryGetTextOfPropertyName(name: PropertyName | NoSubstitutionTemplateLiteral): __String | undefined;
/** @internal */
export declare function getTextOfPropertyName(name: PropertyName | NoSubstitutionTemplateLiteral): __String;
/** @internal */
...
/** @internal */
export declare function createDiagnosticForNode(node: Node, message: DiagnosticMessage, arg0?: string | number, arg1?: string | number, arg2?: string | number, arg3?: string | number): DiagnosticWithLocation;
/** @internal */
export declare function createDiagnosticForNodeArray(sourceFile: SourceFile, nodes: NodeArray<Node>, message: DiagnosticMessage, arg0?: string | number, arg1?: string | number, arg2?: string | number, arg3?: string | number): DiagnosticWithLocation;
/** @internal */
export declare function createDiagnosticForNodeInSourceFile(sourceFile: SourceFile, node: Node, message: DiagnosticMessage, arg0?: string | number, arg1?: string | number, arg2?: string | number, arg3?: string | number): DiagnosticWithLocation;
/** @internal */
...
/** @internal */
export declare function getPropertyAssignment(objectLiteral: ObjectLiteralExpression, key: string, key2?: string): readonly PropertyAssignment[];
/** @internal */
...
/** @internal */
export declare function getTsConfigPropArray(tsConfigSourceFile: TsConfigSourceFile | undefined, propKey: string): readonly PropertyAssignment[];
/** @internal */
...
/** @internal */
export declare function getInvokedExpression(node: CallLikeExpression): Expression;
/** @internal */
...
/** @internal */
export declare function getNameOrArgument(expr: PropertyAccessExpression | LiteralLikeElementAccessExpression): MemberName | (Expression & (StringLiteralLike | NumericLiteral));
/**
...
/** @internal */
export declare function getPropertyNameForPropertyNameNode(name: PropertyName): __String | undefined;
/** @internal */
...
/** @internal */
export declare function tryGetPropertyAccessOrIdentifierToString(expr: Expression): string | undefined;
/** @internal */
...
/** @internal */
export declare function createDetachedDiagnostic(fileName: string, start: number, length: number, message: DiagnosticMessage, ...args: (string | number | undefined)[]): DiagnosticWithDetachedLocation;
/** @internal */
...
/** @internal */
export declare function createFileDiagnostic(file: SourceFile, start: number, length: number, message: DiagnosticMessage, ...args: (string | number | undefined)[]): DiagnosticWithLocation;
/** @internal */
export declare function formatMessage(_dummy: any, message: DiagnosticMessage, ...args: (string | number | undefined)[]): string;
/** @internal */
export declare function createCompilerDiagnostic(message: DiagnosticMessage, ...args: (string | number | undefined)[]): Diagnostic;
/** @internal */
...
/** @internal */
export declare function chainDiagnosticMessages(details: DiagnosticMessageChain | DiagnosticMessageChain[] | undefined, message: DiagnosticMessage, ...args: (string | number | undefined)[]): DiagnosticMessageChain;
/** @internal */
