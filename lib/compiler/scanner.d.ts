import { CommentDirective, CommentKind, CommentRange, DiagnosticMessage, JSDocSyntaxKind, JsxTokenSyntaxKind, KeywordSyntaxKind, LanguageVariant, LineAndCharacter, MapLike, ScriptTarget, SourceFileLike, SyntaxKind, TokenFlags } from "./_namespaces/ts";
