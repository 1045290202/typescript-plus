...
import { AssertClause, BuilderProgram, CancellationToken, CompilerHost, CompilerOptions, CreateProgramOptions, Diagnostic, DiagnosticMessage, DiagnosticMessageChain, DiagnosticReporter, DirectoryStructureHost, EmitResult, ExportDeclaration, FileIncludeReason, FileReference, GetCanonicalFileName, HasChangedAutomaticTypeDirectiveNames, HasInvalidatedResolutions, ImportDeclaration, ModuleResolutionCache, ModuleResolutionHost, Node, PackageId, PackageJsonInfoCache, ParseConfigFileHost, ParsedCommandLine, Path, Program, ProgramHost, ProjectReference, ReferencedFile, ResolutionMode, ResolvedConfigFileName, ResolvedModuleFull, ResolvedModuleWithFailedLookupLocations, ResolvedProjectReference, ResolvedTypeReferenceDirectiveWithFailedLookupLocations, SourceFile, StringLiteralLike, TypeReferenceDirectiveResolutionCache, WriteFileCallback } from "./_namespaces/ts";
...
/** @internal */
export declare function createCompilerHostWorker(options: CompilerOptions, setParentNodes?: boolean, system?: ts.System): CompilerHost;
/** @internal */
 ...
 */
export declare function getModeForFileReference(ref: FileReference | string, containingFileMode: ResolutionMode): ts.ResolutionMode;
/**
...
/** @internal */
export declare function getResolutionModeOverrideForClause(clause: AssertClause | undefined, grammarErrorOnNode?: (node: Node, diagnostic: DiagnosticMessage) => void): ts.ModuleKind.CommonJS | ts.ModuleKind.ESNext | undefined;
/** @internal */
...
/** @internal */
export declare function getImpliedNodeFormatForFileWorker(fileName: string, packageJsonInfoCache: PackageJsonInfoCache | undefined, host: ModuleResolutionHost, options: CompilerOptions): ts.ModuleKind.CommonJS | ts.ModuleKind.ESNext | Partial<ts.CreateSourceFileOptions> | undefined;
/** @internal */
...
/** @deprecated @internal */
export declare function createPrependNodes(projectReferences: readonly ProjectReference[] | undefined, getCommandLine: (ref: ProjectReference, index: number) => ParsedCommandLine | undefined, readFile: (path: string) => string | undefined, host: CompilerHost): ts.InputFiles[];
/**
