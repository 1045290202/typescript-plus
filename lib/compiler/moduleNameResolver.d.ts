import { CommandLineOption, CompilerOptions, DiagnosticMessage, DiagnosticReporter, GetEffectiveTypeRootsHost, MapLike, ModuleResolutionHost, Path, Push, ResolutionMode, ResolutionNameAndModeGetter, ResolvedModuleWithFailedLookupLocations, ResolvedProjectReference, ResolvedTypeReferenceDirectiveWithFailedLookupLocations, SourceFile } from "./_namespaces/ts";
/** @internal */
...
export declare function createModuleResolutionCache(currentDirectory: string, getCanonicalFileName: (s: string) => string, options?: CompilerOptions): ModuleResolutionCache;
 ...
 * @internal
 */
export declare function parseNodeModuleFromPath(resolved: string): string | undefined;
/** @internal */
