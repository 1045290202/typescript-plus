...
import { BuilderProgram, BuilderProgramHost, BuilderState, BuildInfo, BundleBuildInfo, CompilerHost, CompilerOptions, Diagnostic, DiagnosticCategory, DiagnosticMessageChain, EmitAndSemanticDiagnosticsBuilderProgram, HostForComputeHash, Path, Program, ProjectReference, ReadBuildProgramHost, SemanticDiagnosticsBuilderProgram, SourceFile, WriteFileCallbackData } from "./_namespaces/ts";
/** @internal */
 ...
 * @internal
 */
export declare function getBuilderFileEmit(options: CompilerOptions): ts.BuilderFileEmit;
/**
