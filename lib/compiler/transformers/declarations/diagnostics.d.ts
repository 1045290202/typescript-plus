import { BindingElement, CallSignatureDeclaration, ConstructorDeclaration, ConstructSignatureDeclaration, DeclarationName, DiagnosticMessage, ExpressionWithTypeArguments, FunctionDeclaration, GetAccessorDeclaration, ImportEqualsDeclaration, IndexSignatureDeclaration, JSDocCallbackTag, JSDocEnumTag, JSDocTypedefTag, MethodDeclaration, MethodSignature, Node, ParameterDeclaration, PropertyAccessExpression, PropertyDeclaration, PropertySignature, QualifiedName, SetAccessorDeclaration, SymbolAccessibilityResult, TypeAliasDeclaration, TypeParameterDeclaration, VariableDeclaration } from "../../_namespaces/ts";
/** @internal */
