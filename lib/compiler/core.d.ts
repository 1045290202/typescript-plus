import { __String, Comparer, Comparison, EqualityComparer, MapLike, Push, Queue, SortedArray, SortedReadonlyArray, TextSpan, UnderscoreEscapedMap } from "./_namespaces/ts";
/** @internal */
...
/** @internal */
export declare function createMultiMap<V>(): MultiMap<string, V>;
/** @internal */
...
/** @internal */
export declare function createUnderscoreEscapedMultiMap<T>(): UnderscoreEscapedMultiMap<T>;
/** @internal */
...
/** @internal */
export declare const noopPush: Push<any>;
/**
