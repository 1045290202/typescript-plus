import { BuildOptions, CommandLineOption, CommandLineOptionOfCustomType, CommandLineOptionOfListType, CompilerOptions, CompilerOptionsValue, ConfigFileSpecs, Diagnostic, DiagnosticMessage, DidYouMeanOptionsDiagnostics, Expression, FileExtensionInfo, JsonSourceFile, ParseConfigHost, ParsedCommandLine, Path, ProjectReference, PropertyName, Push, TsConfigSourceFile, TypeAcquisition, WatchOptions } from "./_namespaces/ts";
/** @internal */
...
/** @internal */
export declare function parseCustomTypeOption(opt: CommandLineOptionOfCustomType, value: string, errors: Push<Diagnostic>): string | number | undefined;
/** @internal */
export declare function parseListTypeOption(opt: CommandLineOptionOfListType, value: string | undefined, errors: Push<Diagnostic>): string | (string | number)[] | undefined;
/** @internal */
 ...
 * @internal
 */
export declare function convertToObjectWorker(sourceFile: JsonSourceFile, rootExpression: Expression | undefined, errors: Push<Diagnostic>, returnValue: boolean, knownRootOptions: CommandLineOption | undefined, jsonConversionNotifier: JsonConversionNotifier | undefined): any;
/** @internal */
...
/** @internal */
export declare function convertJsonOption(opt: CommandLineOption, value: any, basePath: string, errors: Push<Diagnostic>): CompilerOptionsValue;
/**
