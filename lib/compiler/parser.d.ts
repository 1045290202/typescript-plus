...
import { BaseNodeFactory, DiagnosticMessage, EntityName, JsonSourceFile, JsxTagNameExpression, Node, NodeArray, PackageJsonInfo, PragmaContext, ResolutionMode, ScriptKind, ScriptTarget, SourceFile, TextChangeRange } from "./_namespaces/ts";
/**
...
/** @internal */
export declare const parseNodeFactory: ts.NodeFactory;
/** @internal */
export declare function isJSDocLikeText(text: string, start: number): boolean;
/** @internal */
export declare function isFileProbablyExternalModule(sourceFile: SourceFile): ts.Node | undefined;
/**
