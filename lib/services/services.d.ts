import { CancellationToken, CompilerOptions, CreateSourceFileOptions, DocumentRegistry, EditorOptions, EditorSettings, EmitTextWriter, FormatCodeOptions, FormatCodeSettings, HostCancellationToken, IScriptSnapshot, JsxAttributes, LanguageService, LanguageServiceHost, LanguageServiceMode, Node, ObjectLiteralElement, ObjectLiteralExpression, PropertyName, ScriptKind, ScriptTarget, SourceFile, Symbol, SymbolDisplayPart, TextChangeRange, Type, TypeChecker, UnderscoreEscapedMap } from "./_namespaces/ts";
 ...
 * @internal
 */
export declare function getNameTable(sourceFile: SourceFile): UnderscoreEscapedMap<number>;
/**
