...
/** @internal */
export declare function isStringAndEmptyAnonymousObjectIntersection(type: Type): boolean | 0;
/** @internal */
export declare function isPunctuation(kind: SyntaxKind): boolean;
/** @internal */
...
/** @internal */
export declare function diagnosticToString(diag: DiagnosticAndArguments): string;
/**
